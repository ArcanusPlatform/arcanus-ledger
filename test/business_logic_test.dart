  ...
  group('Business Logic Tests (Properties 13-20)', () {
    ...
    test(
      ...
      await runner.run((iteration, database) async {
        ...
        // Opening balance is treated as the first debit in the account summary.
        // Expected: opening balance (1000) + invoices (800) - paid (1000) = 800
        const expectedTotalInvoiced = 1800.0;
        const expectedTotalPaid = 1000.0;
        const expectedBalance = 800.0;
